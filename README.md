...
> Otvoriť túto stránku na [https://jarosolanic.github.io/smiley-buttons/](https://jarosolanic.github.io/smiley-buttons/)
...
* vyhľadať **https://github.com/jarosolanic/smiley-buttons** a importovať

## Upraviť tento projekt ![Odznak stavu zostavy](https://github.com/jarosolanic/smiley-buttons/workflows/MakeCode/badge.svg)

Ak chcete upraviť tento odkladací priestor v aplikácii MakeCode.

* otvoriť [https://makecode.microbit.org/](https://makecode.microbit.org/)
* kliknite na **Importovať** a potom na **Importovať adresu URL**
* prilepte **https://github.com/jarosolanic/smiley-buttons** a kliknite na tlačidlo importu
...
![Vykreslené zobrazenie blokov](https://github.com/jarosolanic/smiley-buttons/raw/master/.github/makecode/blocks.png)
